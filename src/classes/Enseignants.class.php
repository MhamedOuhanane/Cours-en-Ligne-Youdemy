            ...
            if ($this->status == 'En Vérification') {
                echo '<div class="enseignant bg-white rounded-xl shadow-lg p-6 hover:scale-[1.01]">
                            ...
                            <div class="flex gap-2">
                                <button data-valide="'. htmlspecialchars($this->id_user) .'" class="valide flex-1 border-2 border-green-500 text-green-500 hover:text-white rounded-lg hover:bg-green-600">
                                    <i class="fas fa-check"></i>
                                </button>
                                <button data-refuse="'. htmlspecialchars($this->id_user) .'" class="refuse flex-1 border-2 border-red-500 text-red-500 hover:text-white rounded-lg hover:bg-red-600">
