            ...
            if ($this->status == 'En Vérification') {
                echo '<div class="bg-white rounded-xl shadow-sm p-6">
                            <div class="flex flex-col items-center mb-4">
                                ...
                                <p class="text-gray-500 text-sm">'. htmlspecialchars($this->username) .'</p>
                                <p class="text-gray-500 text-sm">'. htmlspecialchars($this->ville) .'</p>
                                <p class="text-gray-500 text-sm">'. htmlspecialchars($this->telephone) .'</p>
                            </div>
